...
def evaluate_mcmot_seqs(test_root, default_fps=15):
    """
    :param test_root:
    ...
    for i, seq_name in enumerate(seq_names):
        seq_name = seq_name[:-4]
        gt_path = test_root + '/' + seq_name + '_gt_fps' + str(default_fps) + '_re.txt'
        res_path = test_root + '/' + seq_name + '_results_fps' + str(default_fps) + '_re.txt'
...
if __name__ == '__main__':
    ...
    evaluate_mcmot_seqs(test_root='./video_data',
                        default_fps=15)
